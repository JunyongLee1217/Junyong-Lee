// Junyong Lee
// 800623507
// localhost:8080 will give you '404 Not found', and 
// localhost:8080/test.html will show you the test.html file in the same directory
...
public void run()
{
   ...
   try {
      ...
      {
        currentType = "image/x-icon";
      }
      
      
      writeHTTPHeader(os, currentType, path);
      
      if( (extension.equals("png")) || (extension.equals("jpg")) || (extension.equals("gif")) || (extension.equals("ico")) )
      {
        writeImageContent(os, path.substring(1), extension);
      }
      else
      {
        writeContent(os, path.substring(1));
      }
...
private void writeContent(OutputStream os, String path) throws Exception
{
		...
		if (f.exists()) {
		   ...
		   while(line != null) {
			   ...
			   if(line.contains("<cs371date>")) {
				   ...
				   line += "Junyong Lee's Webserver here";
			   }
    ...
    private void writeImageContent(OutputStream os, String path, String extension) throws Exception
    {
        System.out.println(path);
